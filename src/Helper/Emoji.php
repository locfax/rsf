...
class Emoji {
    ...
    function emoji_get_name($unified_cp) {
        return $this->emoji_maps[$unified_cp] ? $this->emoji_maps[$unified_cp] : '?';
    }
    ...
    function emoji_to_string($text, $replaceStr = "#") {
        $text = str_ireplace(array_keys($this->emoji_maps), $this->coverString($replaceStr), $this->coverString($text));
